...
mode: agent
---
I want to implenment a vey specific feature.Currently the codebase is calling a specific AI Engine, namely Anthropic, but I want it to be able to call deifferent ones, like GPT-4, Gemini Pro, etc.
